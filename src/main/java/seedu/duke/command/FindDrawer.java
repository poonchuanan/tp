...
public class FindDrawer extends listDrawer {
    ...
    protected final int START_INDEX_FOR_DESCRIPTION = 49;
    protected final int START_INDEX_FOR_CALORIES = 100;
    protected final int MAX_STRING_FOR_DESCRIPTION = 36 + DESCRIPTION.length();
    protected final int START_INDEX_FOR_EXERCISE_TYPE = 19;
    protected final int START_INDEX_FOR_FOOD_TYPE = 21;
    private final int START_INDEX_FOR_ACTIVITY_DATE = 9;
