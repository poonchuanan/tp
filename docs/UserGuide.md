...
* [Features](#features)
    ...
    * [Finding entries via keyword (basic)](#finding-entries-via-keyword-(basic)): `find`
    * [Finding entries via keywords (advanced)](#finding-entries-via-keywords-(advanced)): `find`
